...
<html>
    <head>
        <link rel="shortcut icon" href="img/ban.jpg" />
        <title>Store</title>
        <meta charset="UTF-8">
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to StanleySylvia Store!</h1>
                    <p>We have the best cameras, hand watches and men shirts for you!. No need to hunt around, we have all in one place.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
